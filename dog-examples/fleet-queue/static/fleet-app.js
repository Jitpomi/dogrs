class FleetQueueManager {
            ...
            vehicles: [
                {
                    ...
                    status: 'active',
                    route: {
                        from: 'Vienna Logistics Hub',
                        to: 'Istanbul Distribution Center',
                        eta: '3h 12m',
                        distance: '1,247 km'
                    },
                    location: {
    ...
    initializeMap() {
        ...
        try {
            ...
            this.map = tt.map({
                ...
                container: 'mapView',
                center: [0, 20], // World center coordinates
                zoom: 0.5,
                language: 'en-US'
            });
    ...
    addFleetMarkers() {
        ...
        this.fleetData.vehicles.forEach(vehicle => {
            ...
            // Create popup with enhanced design
            const popup = new tt.Popup({ 
                offset: 35,
                className: 'fleet-popup'
            }).setHTML(`
                <div class="fleet-popup-content">
                    <div class="popup-header">
                        <div class="vehicle-id">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <path d="M14 16H9m10 0h3m-3-3.5a3.5 3.5 0 0 1-7 0v-9a3.5 3.5 0 0 1 7 0v9Z"/>
                                <path d="M7 14a3 3 0 0 0 0-6h-.5"/>
                            </svg>
                            <span class="vehicle-number">${vehicle.id}</span>
                        </div>
                    ...
                    <div class="driver-info">
                        <img src="${vehicle.driver.avatar}" alt="${vehicle.driver.name}" class="driver-avatar">
                        <div class="driver-details">
                            <span class="driver-name">${vehicle.driver.name}</span>
                    ...
                    <div class="trip-stats">
                        <div class="stat-item">
                            ...
                            <div class="stat-content">
                                <span class="stat-value">${vehicle.route.eta}</span>
                        ...
                        <div class="stat-item">
                            ...
                            <div class="stat-content">
                                <span class="stat-value">${vehicle.route.distance}</span>
