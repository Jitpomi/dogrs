...
pub fn register_hooks(
    ...
    app.service_hooks("certifications", |h| {
        h.before(
            dog_core::ServiceMethodKind::Find,
            Arc::new(super::certifications_hooks::BeforeRead),
        );
        h.after(
            dog_core::ServiceMethodKind::Find,
            Arc::new(super::certifications_hooks::AfterRead),
        );
        h.before(
            dog_core::ServiceMethodKind::Create,
            Arc::new(super::certifications_hooks::BeforeWrite),
        );
        h.after(
            dog_core::ServiceMethodKind::Create,
            Arc::new(super::certifications_hooks::AfterWrite),
        );
    });
    Ok(())
}
